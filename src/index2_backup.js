...
class Player {
    ...
    draw2() {
        c.drawImage(this.playerSprite, 200, 200, spriteWidth, spriteHeight, this.x, this.y,
            this.width * 2, this.height * 2)
    }
...
function eachEnemy() {
    enemies.forEach((enemy, idx) => {
        ...
        if (distance - enemy.radius - projectile.radius < 1) { // we need to check the enemy radius and the projectile radius
            ...
            const distance = Math.hypot((player.x + xDiffOffset) - enemy.x, (player.y + yDiffOffset) - enemy.y) - enemy.radius
